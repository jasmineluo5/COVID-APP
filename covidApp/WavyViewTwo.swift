...
//  covidApp
//
//  Created by Mark Qiao on 6/27/21.
//

import UIKit

class WavyViewTwo: UIView {
    ...
    override init(frame: CGRect) {
        ...
        override func draw(_ rect: CGRect) {
            ...
            ("Have a meeting ID? Video Chat with your doctor here." as NSString).draw(in: textRect, withAttributes: textAttrs)
        }
